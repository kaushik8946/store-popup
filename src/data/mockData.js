...
export const MOCK_ORDER_PRODUCTS = [
    { sNo: 1, productName: 'DOLO 650MG TAB', manufacturer: 'MICRO LABS LIMITED', pack: '10', mrp: 2.06, qty: 30, userQty: 30, amount: 61.80, barcode: '1124554000123', 
      batches: [
    ...
    { sNo: 2, productName: 'ECOSPRIN 75MG TAB', manufacturer: 'USV PVT LTD', pack: '10', mrp: 3.30, qty: 20, userQty: 20, amount: 8.00, barcode: '1122956000456',
      batches: [
    ...
    { sNo: 3, productName: 'PAN 40MG TAB', manufacturer: 'ALKEM LABORATORIES', pack: '15', mrp: 11.22, qty: 20, userQty: 20, amount: 224.40, barcode: '1122956000789',
      batches: [
    ...
    { sNo: 4, productName: 'OKACET TAB', manufacturer: 'CIPLA', pack: '10', mrp: 2.14, qty: 10, userQty: 10, amount: 21.40, barcode: '1124845001234',
      batches: [
    ...
    { sNo: 5, productName: 'PARACIP 500MG', manufacturer: 'CIPLA', pack: '10', mrp: 1.50, qty: 20, userQty: 20, amount: 30.00, barcode: '1124845005678',
      batches: [
    ...
    { sNo: 6, productName: 'AMOXICILLIN 250MG', manufacturer: 'GLAXO', pack: '10', mrp: 5.00, qty: 21, userQty: 21, amount: 105.00, barcode: '1124845009012',
      batches: [
